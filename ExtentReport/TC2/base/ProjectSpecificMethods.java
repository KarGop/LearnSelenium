package extentReports.TC2.base;
...
import extentReports.TC2.utils.ReadExcelCreateLead;
...
public class ProjectSpecificMethods {
	...
	public void reportStep(String msg, String status) throws IOException {
		if(status.equalsIgnoreCase("pass")) {
			//test.pass(msg,MediaEntityBuilder.createScreenCaptureFromPath("/home/karthika/eclipse-workspace/PageObjectModel/snaps/img"+takeSnap()+".png").build());
			...
			//test.fail(msg,MediaEntityBuilder.createScreenCaptureFromPath("/home/karthika/eclipse-workspace/PageObjectModel/snaps/img"+takeSnap()+".png").build());
			...
			//To stop the further execution if TC is fails
	...
	public void startReport() {
		...
		reporter = new ExtentHtmlReporter("./src/main/java/extentReports/report/Results.html");
